...
* `app.ts` it's an entrypoint to execute a sudoku validation. Feel free to change it as you need.
* `src/SudokuChecker.ts` it's a class intended to be the sudoku checker. Feel free to change it as you need.
